...
**Should Fix (Recommended):** 3. Extract duplicated validation logic to shared function (30min effort)

**Optional (Future):** 4. Change empty string defaults to undefined for optional fields 5. Add E2E integration test for full edit flow
